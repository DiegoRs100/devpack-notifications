...
namespace Devpack.Notifications.Notifier
{
    public class Notifier : INotifier
    {
        ...
        public Task Notify(string message, HttpStatusCode notificationType = HttpStatusCode.UnprocessableEntity)
        {
        ...
        public Task Notify(string errorCode, string message, HttpStatusCode notificationType = HttpStatusCode.UnprocessableEntity)
        {
            if (message.IsNullOrWhiteSpace())
                return Task.CompletedTask;
        ...
        public Task Notify(string errorCode, string field, string message, HttpStatusCode notificationType = HttpStatusCode.UnprocessableEntity)
        {
            if (message.IsNullOrWhiteSpace())
                return Task.CompletedTask;
        ...
        public async Task Notify(ValidationResult validationResult, HttpStatusCode notificationType = HttpStatusCode.UnprocessableEntity)
        {
